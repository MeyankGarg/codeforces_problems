...
int main() {
    ...
    while (t--) {
        ...
        vector<long long> left_prefix(n,-1),right_prefix(n,-1);

        for(int i=0;i<m;i++){
            left_prefix[pos[i]-1]=tempt[i];

            right_prefix[pos[i]-1]=tempt[i];

        }
        //  for(auto &itr:left_prefix){
        //     cout<<itr<<" ";
        // }
        // cout<<endl;
        // for(auto &itr:right_prefix){
        //     cout<<itr<<" ";
        // }
        // cout<<endl;

        if(left_prefix[0]==-1){
            left_prefix[0]=INT_MAX;
        }else{
            left_prefix[0]-=1;
        ...
        for(int i=1;i<n;i++){
            ...
            if(left_prefix[i]==-1){
                ...
                left_prefix[i]=min(left_prefix[i-1],left_prefix[i]-i-1);
            }

        }

        if(right_prefix[n-1]==-1){
            right_prefix[n-1]=INT_MAX;
        }else{
            right_prefix[n-1]+= n;
        ...
        for(int i=n-2;i>=0;i--){
            if(right_prefix[i]==-1){
                ...
                right_prefix[i]=min(right_prefix[i+1],right_prefix[i]+i+1);
            }
        }
        ...
        for(int i=0;i<n;i++){
            long long temp= min(left_prefix[i]+i+1,right_prefix[i] -i-1);
            cout<<temp<<" ";
        }
        cout<<endl;
