    ...
    for(int i=0;i<s.length();i++){
        ...
        if(v[index^1].empty()){
            ...
            if(v[index].empty()){
                ...
                // v[index].push_back(v[index].back()+1);
                
                v[index].insert(*(v[index].rbegin())+1);
                // cout<<*(v[index].rbegin())<<" , "<<i<<" "<<index<<endl;
                ans[i]=*v[index].rbegin();
            ...
            // v[index].push_back(v[index^1].front());
            // v[index^1].pop_front();
            // ans[i]=v[index].back();
            ans[i]=*(v[index^1].begin());

            v[index].insert(*(v[index^1].begin()));
            v[index^1].erase(v[index^1].begin());
